...
final class Clover
{
    ...
    public function process(CodeCoverage $coverage, ?string $target = null, ?string $name = null): string
    {
        ...
        foreach ($report as $item) {
            ...
            $xmlMetrics->setAttribute('implementations', (string) $item->numberOfClassesAndTraits());
        ...
        $xmlMetrics->setAttribute('loc', (string) $linesOfCode['linesOfCode']);
        $xmlMetrics->setAttribute('ncloc', (string) $linesOfCode['nonCommentLinesOfCode']);
        $xmlMetrics->setAttribute('implementations', (string) $report->numberOfClassesAndTraits());
