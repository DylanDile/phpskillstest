...
final class Instantiator implements InstantiatorInterface
{
     ...
     * the method {@see \Serializable::unserialize()} when dealing with implementations implementing
    ...
    /**
     * Used to instantiate specific implementations, indexed by class name.
     *
     * @var callable[]
     */
